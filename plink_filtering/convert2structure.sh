...
#Usage: sbatch convert2structure.sh

#specify the directory containing the data
cd /home/ikb001/15pops_filtering/plink_filtering/
...
plink --bfile 14pop_biallelic_snps_miss0.4_thin10.newID.mac1.maf0.01.ldkb1r0.8 --aec --out 14pop_biallelic_snps_miss0.4_thin10.newID.mac1.maf0.01.ldkb1r0.8 --recode structure
