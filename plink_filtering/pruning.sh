...
# create two files, one with the pruned SNPs and one with the SNPs that were not pruned
plink --bfile 14pop_biallelic_snps_miss0.4_thin10.newID.mac1.maf0.01 --aec --indep-pairwise 1 kb 1 0.8 --out 14pop_biallelic_snps_miss0.4_thin10.newID.mac1.maf0.01.ldkb1r0.8 &> /dev/null
