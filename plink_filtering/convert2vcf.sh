...
# convert to vcf
plink --bfile 14pop_biallelic_snps_miss0.4_thin10.newID.mac1.maf0.01.ldkb1r0.8 --aec --out 14pop_biallelic_snps_miss0.4_thin10.newID.mac1.maf0.01.ldkb1r0.8 --recode vcf-iid
