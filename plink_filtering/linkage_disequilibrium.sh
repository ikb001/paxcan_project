...
#Usage: sbatch linkage_disequilibrium.sh
...
plink --bfile 14pop_biallelic_snps_miss0.4_thin10.newID.mac1.maf0.01 --aec --r2 --ld-window-kb 1 --ld-window 1000 --ld-window-r2 0 --out 14pop_biallelic_snps_miss0.4_thin10.newID.mac1.maf0.01.pairwise.1kb.r0
