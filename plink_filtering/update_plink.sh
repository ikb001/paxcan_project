...
# update plink files
plink --file 14pop_biallelic_snps_miss0.4_thin10 --aec --update-ids 14pop_updateID.txt --make-bed --recode --out 14pop_biallelic_snps_miss0.4_thin10.newID
